...
export default function UserReview({ className }: Props) {
  return (
    <Card className={className}>
      ...
      <p className="text-t-muted leading-relaxed text-xs mb-4">
        Ваша анонимность под защитой
      </p>

      <label className="block mb-1.5">
        Тема отзыва <span className="text-t-muted">(необязательно)</span>
      </label>
      <Input w="full" />
      ...
      <div className="relative">
        ...
        />
        <span className="absolute bottom-2 right-4 text-xs text-t-muted">
          0 / 5000
        </span>
      </div>
